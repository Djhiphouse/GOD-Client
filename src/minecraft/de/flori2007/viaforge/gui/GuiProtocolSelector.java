...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_) {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.GOLD.toString() + "God Version Control",
                this.width / 4, 6, 16777215);
        GL11.glPopMatrix();

        drawString(this.fontRendererObj, Client.getInstance().getCLIENT_NAME() + " Client", 1, 1, -1);
        drawString(this.fontRendererObj, "Discord: Bratwurst001#0119", 1, 11, -1);
