...
public class Nullping extends GuiScreen {
    ...
    public Nullping(GuiScreen before) {
        Nullping.before = before;
    }
        ...
        switch (button.id) {
            ...
            case 2:
                ...
                if (split.length == 2) {
                    ...
                    try {
                        final String exe = "java -jar C:\\Users\\Gaming\\AppData\\Roaming\\.minecraft\\God\\Tools\\botnullping.jar";
                        final Process exec = Runtime.getRuntime().exec(exe + " " + ip + " " + port + " " + "2500 60");
                        ...
                        new Thread(() -> {
                            ...
                            String line;
                            try {
                                outputStream.write((ip + " " + port + " " + "2500 60").getBytes(StandardCharsets.UTF_8));
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 3 + 66, 200, 20, "Nullping"));
