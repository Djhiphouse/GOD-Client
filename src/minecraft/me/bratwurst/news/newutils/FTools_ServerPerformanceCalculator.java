...
import me.bratwurst.utils.FTools_MiscUtils;

import java.util.ArrayList;
import java.util.Arrays;

public class FTools_ServerPerformanceCalculator {
    ...
    public static void calculate() {
        FTools_ServerPerformanceCalculator.calculateLag();
        FTools_ServerPerformanceCalculator.calculateTps();
    }
    ...
    public static String getFormatTps() {
        ...
        return FTools_MiscUtils.getTPSColor(lastTps) + fm + " \u00a77(\u00a7e\u00b1" + FTools_MiscUtils.getTPSColor(median) + String.format("%.3f", 20.0 - median) + "\u00a77) (" + FTools_MiscUtils.getTPSColorByProzent(tpsPercentage) + String.format("%.3f", tpsPercentage) + "\u00a77/" + FTools_MiscUtils.getTPSColorByProzent(100.0 - tpsPercentage) + String.format("%.3f", 100.0 - tpsPercentage) + "\u00a7e\u00a7l%\u00a77)";
    }
