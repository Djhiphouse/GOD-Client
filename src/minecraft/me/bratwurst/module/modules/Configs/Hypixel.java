...
public class Hypixel extends Module {
    public Hypixel() {
        super("Hypixel", Category.Configs);
    }


    @EventTarget
    public void onUpdate(EventMotionUpdate e) {
        Minecraft.getMinecraft().thePlayer.sendChatMessage(".config load Hypixel");
        PlayerUtils.sendMessage(EnumChatFormatting.AQUA + " Hypixel Config Geladen");
