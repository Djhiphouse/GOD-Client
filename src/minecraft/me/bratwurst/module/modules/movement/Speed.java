...
public class Speed extends Module {
    ...
    public void setup() {
        ...
        Client.setmgr.rSetting(TeleportDelay = new Setting("TPDelay", this, 1000, 100, 2000, true));
    ...
    public void onUpdate(EventUpdate event) {
        ...
        if (mode1.getValString().equalsIgnoreCase("Onground")) {
            ...
            Teleport(TeleportDelay.getValInt());
    ...
    public void Teleport(double Speed2) {
        double x = mc.thePlayer.posX;
        double y = mc.thePlayer.posY;
        double z = mc.thePlayer.posZ;
        if (TimeHelper.hasReached((long) Speed2)) {
            mc.thePlayer.setPositionAndUpdate(x + 4, y, z);
            TimeHelper.reset();
        }
    }
