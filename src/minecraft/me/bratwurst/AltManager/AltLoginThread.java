...
public final class AltLoginThread extends Thread {
    ...
    public AltLoginThread(Alt alt) {
        ...
        this.alt = alt;
        this.status = EnumChatFormatting.BLUE + "Waiting...";
        mojang = true;
    }
    ...
    private Session createSession(final String username, final String password) {
        ...
        if (mojang) {
            Client.instance.switchService(AlteningServiceType.MOJANG);
        } else {
            Client.instance.switchService(AlteningServiceType.THEALTENING);
        }
