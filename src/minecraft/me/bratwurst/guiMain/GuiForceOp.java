...
public class GuiForceOp extends GuiScreen {
    ...
    public GuiForceOp(GuiScreen before) {
    ...
    public void initGui() {
        ...
        ip.setText("njsystems.de");
        cmd.setText("say Hallo by " + Minecraft.getMinecraft().session.getUsername());
        this.status = "\u00a76ForceOp";
        ip.setFocused(false);
        cmd.setFocused(true);
