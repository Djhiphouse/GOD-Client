...
public class GuiLuckperms extends GuiScreen{
    ...
    public GuiLuckperms(GuiScreen before) {
    ...
    public void initGui() {
        ...
        cmd.setText("luckperms user " + Minecraft.getMinecraft().session.getUsername() + " permission add perms.*");
        this.status = "\u00a76Gib Jemanden Luckperms *";
        ip.setFocused(false);
        cmd.setFocused(true);
