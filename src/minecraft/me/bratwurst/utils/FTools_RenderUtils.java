...
public class FTools_RenderUtils
        implements FTools_MinecraftHook {
    ...
    public static void entityESPBox(Entity entity, int mode) {
        ...
        if (mode == 0) {
            GL11.glColor4d((double)(1.0f - FTools_RenderUtils.MC.thePlayer.getDistanceToEntity(entity) / 40.0f), (double)(FTools_RenderUtils.MC.thePlayer.getDistanceToEntity(entity) / 40.0f), (double)0.0, (double)0.5);
        } else if (mode == 1) {
        ...
        RenderGlobal.drawSelectionBoundingBox(new AxisAlignedBB(entity.getEntityBoundingBox().minX - 0.05 - entity.posX + (entity.posX - FTools_RenderUtils.MC.getRenderManager().renderPosX), entity.getEntityBoundingBox().minY - entity.posY + (entity.posY - FTools_RenderUtils.MC.getRenderManager().renderPosY), entity.getEntityBoundingBox().minZ - 0.05 - entity.posZ + (entity.posZ - FTools_RenderUtils.MC.getRenderManager().renderPosZ), entity.getEntityBoundingBox().maxX + 0.05 - entity.posX + (entity.posX - FTools_RenderUtils.MC.getRenderManager().renderPosX), entity.getEntityBoundingBox().maxY + 0.1 - entity.posY + (entity.posY - FTools_RenderUtils.MC.getRenderManager().renderPosY), entity.getEntityBoundingBox().maxZ + 0.05 - entity.posZ + (entity.posZ - FTools_RenderUtils.MC.getRenderManager().renderPosZ)));
