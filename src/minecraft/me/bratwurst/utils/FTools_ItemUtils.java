...
public class FTools_ItemUtils {
    ...
    public static ItemStack getKillPotion() {
        ItemStack stack = FTools_ItemUtils.createSplashBase();
    ...
    public static ItemStack getForceOpBook(String command) {
        ...
        list.appendTag(new NBTTagString("{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"%COMMAND%\"},\"hoverEvent\":{\"action\":\"show_text\",\"value\":{\"text\":\"%HOVERTEXT%\"}},\"text\":\"%TEXT%\"}".replace("%COMMAND%", command).replace("%HOVERTEXT%", "\u00a7[Click]").replace("%TEXT%", FTools_ItemUtils.getSpaces())));
