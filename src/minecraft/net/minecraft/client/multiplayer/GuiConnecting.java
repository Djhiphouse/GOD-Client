...
public class GuiConnecting extends GuiScreen
{
    ...
    private void connect(final String ip, final int port)
    {
        ...
        logger.info(EnumChatFormatting.BLUE +"Verbinden zu " + ip + ", " + port);
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    GuiConnecting.logger.error( EnumChatFormatting.BLUE +"Es konnte keine verbindung zum server Aufgebaut werden!", (Throwable)unknownhostexception);
