...
public class PlayerControllerMP
{
    ...
    public boolean func_178890_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 p_178890_6_) {
        ...
        if (this.currentGameType != WorldSettings.GameType.SPECTATOR) {
            ...
            if ((!p_178890_1_.isSneaking() || p_178890_1_.getHeldItem() == null) && var11.getBlock().onBlockActivated(p_178890_2_, p_178890_4_, var11, (EntityPlayer)p_178890_1_, p_178890_5_, var7, var8, var9))
                var10 = true;
            if (!var10 && p_178890_3_ != null && p_178890_3_.getItem() instanceof ItemBlock) {
                ItemBlock var12 = (ItemBlock)p_178890_3_.getItem();
                if (!var12.canPlaceBlockOnSide(p_178890_2_, p_178890_4_, p_178890_5_, (EntityPlayer)p_178890_1_, p_178890_3_))
                    return false;
            }
        }
        this.netClientHandler.addToSendQueue((Packet)new C08PacketPlayerBlockPlacement(p_178890_4_, p_178890_5_.getIndex(), p_178890_1_.inventory.getCurrentItem(), var7, var8, var9));
        if (!var10 && this.currentGameType != WorldSettings.GameType.SPECTATOR) {
            ...
            if (this.currentGameType.isCreative()) {
                ...
                boolean var13 = p_178890_3_.onItemUse((EntityPlayer)p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, var7, var8, var9);
                p_178890_3_.setItemDamage(var14);
                p_178890_3_.stackSize = var15;
                return var13;
            }
            return p_178890_3_.onItemUse((EntityPlayer)p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, var7, var8, var9);
        }
        return true;
    }
