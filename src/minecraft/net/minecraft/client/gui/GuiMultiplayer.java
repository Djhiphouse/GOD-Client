...
import me.bratwurst.news.serverfinder.ServerFinderScreen;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void createButtons() {
        this.buttonList.add(this.btnEditServer = new GuiButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format(EnumChatFormatting.BLUE+ "Bearbeiten", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format(EnumChatFormatting.BLUE+ "Entfernen", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format(EnumChatFormatting.BLUE+ "Server Betreten", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format(EnumChatFormatting.BLUE+ "Sofort Verbinden", new Object[0])));
        this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format(EnumChatFormatting.BLUE+ "Server Speichern", new Object[0])));
        this.buttonList.add(new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format(EnumChatFormatting.BLUE+ "Aktualisieren", new Object[0])));
        ...
        this.buttonList.add(new GuiButton(1340, this.width - 110, 24, 100, 20, EnumChatFormatting.AQUA + "Server"+EnumChatFormatting.BLUE+"finder"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            } else if (button.id == 1340) {
                this.mc.displayGuiScreen(new ServerFinderScreen(this));
            }
        }
    }
