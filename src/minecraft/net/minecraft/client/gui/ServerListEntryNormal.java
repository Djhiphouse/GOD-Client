...
import me.bratwurst.utils.ProtocolVersionUtils;
...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
            ...
            field_148302_b.submit(new Runnable()
            {
                public void run()
                {
                    ...
                    catch (UnknownHostException var2)
                    {
                        ...
                        ServerListEntryNormal.this.field_148301_e.serverMOTD = EnumChatFormatting.DARK_RED + "Konnte den Server nicht finden";
                    }
        ...
        // EDITED CLIENT MODS SERVERLIST
        if (this.field_148301_e.pingToServer == -1L) {
            s = "\u00a77Version\u00a78: \u00a7cUnknown";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 1, -1);

            s = "\u00a77Protocol\u00a78: \u00a7cUnknown";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 10, -1);

            s =   "\u00a77Ping\u00a78: \u00a7cUnknown";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 19, -1);

        } else if (this.field_148301_e.pingToServer == -2L) {
            s =  "\u00a77Version\u00a78: \u00a7aLoading...";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 1, -1);

            s = "\u00a77Protocol\u00a78: \u00a7aLoading...";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 10, -1);
            ...
            s = "\u00a77Version\u00a78: \u00a76" + this.field_148301_e.gameVersion.split(" ")[0];
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 1, -1);

            String n = ProtocolVersionUtils.getKnownAs(this.field_148301_e.version);
            s ="\u00a77Protocol\u00a78: \u00a7d" + this.field_148301_e.version + " \u00a77(" + (n == null ? "\u00a7cUnknown\u00a77" : n) + ")";
            this.mc.fontRendererObj.drawString(s, x + listWidth + 7, y + 10, -1);

            s = "\u00a77Ping\u00a78: \u00a7a" + this.field_148301_e.pingToServer;
            this.mc.fontRendererObj.drawString(s, x + listWidth + 20, y + 19, -1);
        }
        // EDITED CLIENT MODS SERVERLIST
        ...
        {
            l = 5;
            s1 = flag ? "Client wurde nich Geupdated!" : "Server Veraltet!";
        ...
        else if (this.field_148301_e.field_78841_f && this.field_148301_e.pingToServer != -2L)
        {
            ...
            if (this.field_148301_e.pingToServer < 0L)
            {
                s1 = EnumChatFormatting.BLUE + "Keine Verbindung";
            }
            else
            {
