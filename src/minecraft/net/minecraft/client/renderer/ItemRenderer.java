        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4:
                        if (me.bratwurst.Client.moduleManager.getModuleByName("BlockAnimation").isToggle()) {
                            switch (me.bratwurst.Client.instance.setmgr.getSettingByName("BlockAnimation").getValString().toLowerCase()) {
                                case "1.7":
                                ...
                                case "astolfo":
                                    ...
                                    if (this.rotateTimer.hasReached(1L)) {
                                        for (int i = 0; i < me.bratwurst.Client.instance.setmgr.getSettingByName("BlockAnimation Speed").getValDouble(); i++) {
                                            ++this.delay;
                                        }
