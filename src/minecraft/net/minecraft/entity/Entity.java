...
import me.bratwurst.module.modules.World.Sacffold;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (flag || SafeWalk.Safewalk || Safewalk == true || Client.getInstance().getModuleManager().getModuleByName("Scaffold").isEnabled()) {
                double d6;
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        EventMove eventMove = new EventMove(strafe, forward, friction);
        eventMove.call();
